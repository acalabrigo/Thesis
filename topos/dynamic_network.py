...
def int2dpid(dpid):
    '''
    Converts an integer to a the same integer as a datapath ID.
    '''
...
def dpid2id(dpid, type='switch'):
    '''
    Converts datapath ID to switch name.
    '''
...
def dpid_to_mac (dpid):
    '''
    Converts datapath ID to MAC address of switch.
    '''
...
class Switch(Device):
    ...
    def add_connection(self, connection):
        '''
        Links the switch to its datapath.
        '''
