# dhcp_server.py 2017 Adam Calabrigo
...
class DHCPDMulti (EventMixin):
  ...
  def _handle_core_ComponentRegistered (self, event):
    ...
    if event.name == "topology_tracker":
      event.component.addListenerByName("StableEvent",
          self._topology_tracker_stable)
      ...
      log.info('connected to topology_tracker')

  # interacting with topology_tracker
  def _topology_tracker_stable (self, event):
    '''
